...
| SEO-04 | P0 | [Remove placeholder social proof and claims](./04-social-proof-cleanup.md) | M | In progress — production records unpublished; guardrail deployment pending | Client/team verification for future content |
