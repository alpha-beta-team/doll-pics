  ...
  return (
    ...
    >
      <div className="relative mx-auto mb-6 h-44 w-44">
        <div className="absolute inset-0 rounded-full border border-gold-400/20 transition-colors duration-500 group-hover:border-gold-400/50 group-hover:shadow-[0_0_40px_-12px_rgb(var(--gold-glow)/0.45)]" />
