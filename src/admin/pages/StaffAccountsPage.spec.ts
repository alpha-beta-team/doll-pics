...
const accounts: StaffAccount[] = [
  ...
  { id: '3', name: 'Arun', employeeCode: 'DP-003', role: 'employee', isActive: true, mustChangePassword: true, attendanceEnabled: true },
];
...
test('filters staff accounts by name or email without case sensitivity', () => {
  ...
  assert.deepEqual(filterStaffAccounts(accounts, 'dp-003'), [accounts[2]]);
