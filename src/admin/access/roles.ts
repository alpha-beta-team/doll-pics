...
export const FEATURE_CATALOG = {
  ...
  payments: { label: 'Revenue & Payments', group: 'settings', routes: ['/admin/payments'], ownerLocked: true, supportedLevels: ownerOnlyLevels, navigation: { id: 'payments', label: 'Revenue & Payments', section: 'sales_finance', displayOrder: 20 } },
  ...
  site_content: { label: 'Site settings and services', group: 'content', routes: ['/admin/site-content', '/admin/services', '/admin/services/new', '/admin/services/:id'], supportedLevels: editableLevels, navigation: { id: 'site-content', label: 'Site Settings', section: 'website', displayOrder: 60, featureFlag: 'website' } },
