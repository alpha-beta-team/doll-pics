...
type Target = { recordType: 'enquiry' | 'booking'; recordId: string; hidden?: boolean; compact?: boolean };
const MAX_SECONDS = 120;

export function VoiceNotesPanel({ recordType, recordId, hidden = false, compact = false }: Target) {
  ...
  return <section hidden={hidden} className={`rounded-2xl border border-slate-200 bg-white ${compact ? 'p-4' : 'p-5'} shadow-sm`}>
