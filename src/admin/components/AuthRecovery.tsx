...
export function AuthRecovery() {
  ...
  return <div className="flex min-h-screen items-center justify-center bg-admin-canvas p-4 text-admin-text">
    {status === 'checking' ? <AdminLoadingState label="Connecting to your account. This may take up to 90 seconds…" /> : <div role="alert" className="max-w-md rounded-xl border border-admin-border bg-admin-surface p-6">
